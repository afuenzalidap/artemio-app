...
import { NavierasList } from '../localdb/data';

export const NavierasPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Navieras' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                navieras.map(({NavieraId, Naviera}) => {
                  return (<tr key={NavieraId}>
                    <td><p className="mb-0 fw-normal">{NavieraId}</p></td>
                    <td><p className="mb-0 fw-normal">{Naviera}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/naviera/${NavieraId}` }>
