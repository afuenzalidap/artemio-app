...
import { CiudadesList } from '../localdb/data';
...
export const CiudadesPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Ciudades' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                ciudades.map(({CiudadId, Ciudad}) => {
                  return (<tr key={CiudadId}>
                    <td><p className="mb-0 fw-normal">{CiudadId}</p></td>
                    <td><p className="mb-0 fw-normal">{Ciudad}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/ciudad/${CiudadId}` }>
