...
import { TemporadasList } from '../localdb/data';
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                temporadas.map(({TemporadaId, Temporada}) => {
                  return (<tr key={TemporadaId}>
                    <td><p className="mb-0 fw-normal">{TemporadaId}</p></td>
                    <td><p className="mb-0 fw-normal">{Temporada}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/temporada/${TemporadaId}` }>
