...
import { NavesList } from '../localdb/data';

export const NavesPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Naves' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                naves.map(({NaveId, Nave}) => {
                  return (<tr key={NaveId}>
                    <td><p className="mb-0 fw-normal">{NaveId}</p></td>
                    <td><p className="mb-0 fw-normal">{Nave}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/nave/${NaveId}` }>
