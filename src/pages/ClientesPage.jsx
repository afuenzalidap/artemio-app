...
import { ClientesList } from '../localdb/data';
...
export const ClientesPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Clientes' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                clientes.map(({ClienteId, Codigo, RazonSocial}) => {
                  return (<tr key={ClienteId}>
                    <td><p className="mb-0 fw-normal">{ClienteId}</p></td>
                    <td><p className="mb-0 fw-normal">{Codigo}</p></td>
                    <td><p className="mb-0 fw-normal">{RazonSocial}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/cliente/${ClienteId}` }>
