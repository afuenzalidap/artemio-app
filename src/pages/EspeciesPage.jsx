...
import { EspeciesList } from '../localdb/data';

export const EspeciesPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Especies' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                especies.map(({EspecieId, Especie}) => {
                  return (<tr key={EspecieId}>
                    <td><p className="mb-0 fw-normal">{EspecieId}</p></td>
                    <td><p className="mb-0 fw-normal">{Especie}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/especies/${EspecieId}` }>
