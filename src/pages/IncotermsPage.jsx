...
import { IncotermsList } from '../localdb/data';
...
export const IncotermsPage = () => {
  ...
  return (
    <>
      <TitleGrid Father='Mantenedores' Child='Incoterms' />
      ...
      <div className="card w-100 position-relative overflow-hidden">
        <div className="card-body p-4">
          ...
          <table className="table border text-nowrap customize-table mb-0 align-middle">
            ...
            <tbody>
              { 
                incoterms.map(({IncotermId, Incoterm}) => {
                  return (<tr key={IncotermId}>
                    <td><p className="mb-0 fw-normal">{IncotermId}</p></td>
                    <td><p className="mb-0 fw-normal">{Incoterm}</p></td>
                    <td>
                      <div className="dropdown dropstart">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <NavLink className="dropdown-item d-flex align-items-center gap-3" to={ `/incoterm/${IncotermId}` }>
